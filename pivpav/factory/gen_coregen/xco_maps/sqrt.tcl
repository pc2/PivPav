...
proc xco_get {param args} {
  switch -glob $param {
    ...
    latency { 
      if {[ string compare $CSET::_pipelining_mode "No_Pipelining"] == 0}  { 
        if {[ string compare $CSET::_register_outputs "true" ] == 0 } {
          return 1
        } else {
          return 0 
        }
      } 
       puts stderr "Cant get latency for component"
       exit 1
    } 
